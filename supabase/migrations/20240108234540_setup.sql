...
AS $$
DECLARE
  project_url TEXT := 'https://mronjhmefodcxkoneyti.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1yb25qaG1lZm9kY3hrb25leXRpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0ODMwNTQxNywiZXhwIjoyMDYzODgxNDE3fQ.1HSSsZssgkqz4VsLo3Mr-mkULAsHx7qCc-RV0XggysY'; -- full access needed for http request to storage
