...
async function applyDeleteFunction() {
  const supabase = createClient(
    process.env.NEXT_PUBLIC_SUPABASE_URL,
    process.env.SUPABASE_SERVICE_ROLE_KEY
  )

  console.log('Applying delete_file_direct function migration...')
  ...
  try {
    ...
    if (response.ok) {
      console.log('✅ delete_file_direct function created successfully!')
      console.log('File deletion should now work properly.')
    } else {
